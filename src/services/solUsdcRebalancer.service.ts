...
/**
 * Rebalancing frequency options for SOL-USDC
 */
...
/**
 * Configuration for SOL-USDC automated rebalancing
 */
export interface SOLUSDCRebalanceConfig {
 ...
 */
export const REBALANCE_PRESETS: Record<RebalanceFrequency, SOLUSDCRebalanceConfig> = {
...
/**
 * SOL-USDC Automated Rebalancing Service
 * Optimized for volatile/stable pairs with intraday price movements
 */
export class SOLUSDCRebalancer {
    private jobs: Map<string, CronJob> = new Map();
    private activePositions: Map<string, SOLUSDCRebalanceConfig> = new Map();

    /**
     * Start automated rebalancing for a SOL-USDC position
     */
    public startAutomation(
        positionAddress: string,
        config: SOLUSDCRebalanceConfig = REBALANCE_PRESETS[RebalanceFrequency.AGGRESSIVE]
    ): void {
...
// Singleton export
export const solUsdcRebalancer = new SOLUSDCRebalancer();
